...
extension ExampleModelQueryFilter
  ...
  QueryBuilder<ExampleModel, ExampleModel, QAfterFilterCondition> nameEqualTo(
    String value, {
  ...
  QueryBuilder<ExampleModel, ExampleModel, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ExampleModel, ExampleModel, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ExampleModel, ExampleModel, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExampleModel, ExampleModel, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExampleModel, ExampleModel, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ExampleModelQuerySortBy
  ...
  QueryBuilder<ExampleModel, ExampleModel, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<ExampleModel, ExampleModel, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExampleModelQuerySortThenBy
  ...
  QueryBuilder<ExampleModel, ExampleModel, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<ExampleModel, ExampleModel, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension ExampleModelQueryWhereDistinct
  ...
  QueryBuilder<ExampleModel, ExampleModel, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ExampleModelQueryProperty
  ...
  QueryBuilder<ExampleModel, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
